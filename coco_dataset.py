...
class CocoDataset(data.Dataset):
    ...
    def collate_fn(self, pairs):
        ...
        captions = [caption[-min(self.max_len, len(caption)): ] for caption in captions]
        ...
        padded_captions = torch.ones((len(captions), self.max_len), dtype=torch.long) * self.vocab.padid
